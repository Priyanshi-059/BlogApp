          ...
          isEditing?(
            ...
            <div className='flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2'>
              <button
                ...
                className={`text-gray-400 ${currentUser && comment.likes.includes(currentUser._id) && '!text-blue-500'}`}
                >
              ...
              </p>  
              {
                currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                  <>
                  <button className='text-gray-500 hover:text-blue-500' type='button' onClick={handleEdit}>
                    Edit
                  </button>
